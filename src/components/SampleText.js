  ...
  render() {
    english = (
      <Fragment>
        ...
        <Text style={{ fontSize: Settings.currentSettingsEnglish[2] }}>
        ...
        >
          ...
          were at first dazzled by the brilliancy of the wonderful City. The streets
          were lined with beautiful houses all built of green marble and studded
          everywhere with sparkling emeralds. They walked over a pavement of the
          same green marble, and where the blocks were joined together were rows of
          emeralds, set closely, and glittering in the brightness of the sun. The
    ...
    urdu = (
      <Fragment>
        ...
        >
          اسلام آباد(اردو پوائنٹ تازہ ترین اخبار۔04اگست 2019ء) قومی ٹیم کے سابق فاسٹ
          باﺅلر شعیب اختر سرجری کے لیے آسٹریلیا روانہ ہوں گے۔ ذرائع نے بتایا ہے کہ
          گھٹنوں کے درد میں مبتلا سابق سپیڈ سٹار شعیب اختر کو بیماری سے جلد چھٹکارے
          کی امید ہے اور وہ آپریشن کیلئے آئندہ ہفتے آسٹریلیا روانہ ہوں گے۔ اپنے یو
          ٹیوب چینل پر شعیب اختر کا کہنا تھا کہ انہیں یہ تکلیف کیریئر کے عروج کے دور
          سے ہے مگر اب امید ہے کہ دو عشرے کی طویل مدت کے بعد اس سے نجات مل جائے گی۔
          شعیب اختر کے مطابق 1997 میں ڈاکٹروں نے انہیں بتایا تھا کہ ان کا کیریئر اس
          تکلیف کی وجہ سے دو سال سے زیادہ طویل نہیں ہو سکے گا لیکن انہوں نے اس کے
          بعد کئی سال تک کرکٹ کھیلی۔ یاد رہے کہ قومی ٹیم کے سابق اسپیڈ اسٹار شعیب
          اختر نے پاکستان کرکٹ بورڈ میں عہدے کے لیے دلچسپی ظاہر کی ہے۔{"\n"}
        </Text>
      </Fragment>
    );
